...
class HomeUserController extends Controller
{
    ...
    public function notifcomment(Request $request)
    {
        $oldSearch = $request->input('search');
        if ($request->has('search')) {
            $ccontent = $request->input('search');
        ...
        return view('user.comment', compact('content', 'likesCount', 'commentCount', 'oldSearch', 'notifications', 'notificationCount'));
    }
