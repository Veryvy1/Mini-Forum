    ...
    <div class="theme-layout">
        ...
        <header class>
            <div class="topbar stick">
                ...
                <div class="searches">
                    <form id="searchForm" action="{{ route('kategori.index') }}" method="get">
                        @csrf
                                            ...
                                            @else
                                                @foreach ($kategori as $key => $kategories)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5>{{ \Carbon\Carbon::parse($kategories->created_at)->isoFormat('D MMMM YYYY') }}
                                                            </h5>
                                                        </td>
                                                        <td style="width: 10%">
                                                            <div class="actions-btn">
                                                                <button type="button"
                                                                    ...
                                                                    data-bs-target="#editModal{{ $kategories->id }}"><i
                                                                        class="icofont-pen-alt-1"></i></button>
                                                                        <form action="{{ route('kategori.destroy', ['kategori' => $kategories->id]) }}" id="deleteForm_{{ $kategories->id }}" method="POST" style="display:inline">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="button" class="iconbox button soft-danger" onclick="deleteContent('{{ $kategories->id }}')">
                        ...
                        <form action="{{ route('kategori.update', $kategories->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('kategori') is-invalid @enderror"
                                    ...
                                    value="{{ old('kategori', $kategories->kategori) }}">
                                @error('kategori')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
