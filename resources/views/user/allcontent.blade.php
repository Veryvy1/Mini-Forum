...
<head>
    ...
    <title>GetForums | More Content</title>
...
<body>
                            ...
                            <div id="page-contents" class="row merged20">
                                <div class="col-lg-9">
                                    <div class="main-wraper">
                                        <div class="main-title">Content Posts</div>
                                        ...
                                        <div class="blog-posts">
                                            ...
                                            <div class="blog-post-meta">
                                                <ul>
                                                    <li><i class="icofont-read-book"></i><a title="Reads"
                                                            href="#">93k</a></li>
                                                    <li><i class="icofont-comment"></i><a title="comments"
                                                            href="#">33</a></li>
                                                </ul>
                                                <h4>{{ $contents->judul }}</h4>
                                                <p>
                                                    Our online class is an affordable alternative to private therapy and
                                                    coaching, and teaches day Lorem ipsum dolor sit amet.
                                                </p>
                                                <span><i class="icofont-clock-time"></i> january 23, 2021</span>
                                                <a href="blog-detail.html" title class="button primary circle">read
                                                    more</a>
                                            </div>
                                        </div>
                                        @empty
                                        ...
                                        <div class="load mt-5 mb-4">
                                            <ul class="pagination">
                                                <li><a href="#" title><i class="icofont-arrow-left"></i></a>
                                                </li>
                                                ...
                                                <li><a href="#" title><i class="icofont-arrow-right"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="select-box">
                                <div class="select-box__current" tabindex="1">
                                    ...
                                    <div class="select-box__value"><input class="select-box__input" type="radio"
                                        ...
                                        <p class="select-box__input-text"><i class="icofont-star"></i> Only Friends
                                        </p>
                                    </div>
                                    <div class="select-box__value"><input class="select-box__input" type="radio"
                        ...
                        <li class="me">
                            ...
                            <div class="notification-event">
                                <div class="chat-message-item">
                                    ...
                                    <div class="caption">4.5kb <i class="icofont-download" title="Download"></i>
                                    </div>
                                </div>
    ...
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="df9917e60bbe58c84a66e080-|49" defer></script>
    <script>
        (function() {
            var js =
                "window['__CF$cv$params']={r:'85d70b180fcf18ca',t:'MTcwOTI3NDA0OS40NjMwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/a0d8959cb7d0/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
